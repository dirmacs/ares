...
pub(crate) fn build_user_memory_if_present(
    user_id: &str,
    facts: Vec<ares_types::types::MemoryFact>,
    preferences: Vec<ares_types::types::Preference>,
) -> Option<UserMemory> {
...
mod tests {
    use super::*;
    use ares_types::types::{MemoryFact, Message, MessageRole, Preference, Source};
    ...
    fn resolve_token_counts_uses_llm_usage_when_available() {
        let usage = ares_llm::client::TokenUsage::new(10, 20);
